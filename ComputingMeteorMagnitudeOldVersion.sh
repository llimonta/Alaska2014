...
declare -a MeteoroidsExcelLocation=(4 5 7 9 11 18 23 26 28)
declare -i START
...
day="Day30032014"; # the night you are analyzing
NightToBeAnalyzed="/mnt/NAS/Ultra/2014-03-30/2014-03-30T10-46-CamSer7196.DMCdata"
#"/media/limo/My Passport/2014-03-31/2014-03-31T06-12-CamSer7196.DMCdata"; #where the file being read is located
...
do	
	...
	RaDecAzElFile="$Folder/RaDecAzElFrame$BegFrame$day.mat"
		matlab -nodesktop -nosplash -nodisplay -r "MeteorMagnitudeEstimation('$Folder','$day','$Folder$SavedStars','$MeteorLuminosityFile','$RaDecAzElFile',$MeteoroidNumber);quit"
...
echo $MeteoroidNumber
done < /home/limo/PHD/astrometry.net-0.73/astrometry/Test.txt
