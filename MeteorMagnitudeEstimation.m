function MeteorMagnitudeEstimation(folder,day,file_saved_stars,meteor_luminosity_file,RaDecAzElfile,meteoroid_number)
...
['/home/limo/PHD/PokerFlat2014/MatlabCode/Data/31-03-2014luminosity_by_hand_for_orbit_determination_meteor_number',num2str(meteoroid_number),'.mat']
load(['/home/limo/PHD/PokerFlat2014/MatlabCode/Data/31-03-2014luminosity_by_hand_for_orbit_determination_meteor_number',num2str(meteoroid_number),'.mat'])
meteor_instrumental_luminosity = luminosity;%Meteoroid{meteoroid_number}.MeteorIntensity;
meteor_time = Meteoroid{meteoroid_number}.tUT;
meteor_location = Meteoroid{meteoroid_number}.KalLoc; % given as meteor_location(1,:) = xpixel,ypixel
...
[folder,'/BandVmagMeteorHand',num2str(meteoroid_number),day,'.mat']
save([folder,'/BandVmagMeteorHand',num2str(meteoroid_number),day,'.mat'],'VmagMeteor','BmagMeteor','meteor_time');
end
